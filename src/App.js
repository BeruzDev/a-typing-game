...
const averageWpm = wpmHistory.length > 0 ? (wpmHistory.reduce((acc, curr) => acc + curr, 0) / wpmHistory.length).toFixed(2) : 0;
        ...
        <div className='display'>
          ...
          <div className='bot-row'>
            <div className='left-column'>
              <Summary averageWpm={averageWpm} lastLevelTime={lastLevelTime} currentLevel={currentLevel} isUserGenerated={isUserGenerated}/>
            </div>
            <div className='center-column'>
              <div className='display-text-display'>
                <TextDisplay isAutoGenerated={isAutoGenerated} activeChar={activeChar} onProgressChange={handleProgressChange} onLevelChange={onLevelChange} onResetLevel={onResetLevel}/>
              </div>
            ...
            <div className='right-column'>
              <StatsPanel wpm={wpm} elapsedTime={elapsedTime} progress={progress}/>
            </div>
          </div>
        </div>
      </div>
